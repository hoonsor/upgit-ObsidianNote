...
modified: Tuesday, November 1st 2022, 10:00:28 pm
---
...
- [[#Obsidian 統整筆記 ^toc|Obsidian 統整筆記]]
	...
	- [[#4. 教學介紹及分享|4. 教學介紹及分享]]
		...
		- [[#4.3. 操作介面介紹|4.3. 操作介面介紹]]
			- [[#4.3.1. 左邊工具欄（含上方小按鈕）|4.3.1. 左邊工具欄（含上方小按鈕）]]
			- [[#4.3.2. 右邊工具欄（含上方小按鈕）|4.3.2. 右邊工具欄（含上方小按鈕）]]
			- [[#4.3.3. 左邊工具欄下方設定按鈕|4.3.3. 左邊工具欄下方設定按鈕]]
			- [[#4.3.4. 中間筆記視窗|4.3.4. 中間筆記視窗]]
			- [[#4.3.5. 下方狀態列|4.3.5. 下方狀態列]]
		- [[#4.4. 主要功能介紹|4.4. 主要功能介紹]]
			- [[#4.4.1. 操作指令|4.4.1. 操作指令]]
			- [[#4.4.2. 筆記建立|4.4.2. 筆記建立]]
			- [[#4.4.3. 查詢筆記|4.4.3. 查詢筆記]]
			- [[#4.4.4. Obsidian 語法|4.4.4. Obsidian 語法]]
